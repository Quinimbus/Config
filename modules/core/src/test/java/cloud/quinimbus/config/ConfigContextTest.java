...
public class ConfigContextTest {
    ...
    @Provider(name = "YAML test config 1", alias = {}, priority = 100)
    ...
    @Provider(name = "YAML test config 2", alias = {}, priority = 200)
    ...
    public static record SLProviderImpl(Class<? extends ConfigProvider> type, ConfigProvider get) implements ServiceLoader.Provider<ConfigProvider> {
